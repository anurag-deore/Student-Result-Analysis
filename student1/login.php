            ...
            <div class="card-body p-4">
                ...
                <div class="card-text">
                    <form class="row g-3 needs-validation" action="" method="POST" novalidate>
                        ...
                        <div class="col-12">
                            Don't have a account ? <a href="<?php echo STUDENT . 'register.php'; ?>">Sign Up</a>
                            <a class="float-end" href="<?php echo FACULTY . 'login.php'; ?>">Faculty Login</a>
                        </div>
                    </form>
                </div>
            </div>
